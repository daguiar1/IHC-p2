    ...
    return (
      <Container>
        ...
        <Center>
          ...
          <List>
            <ListItem><a href="/homeLogged">Home</a></ListItem>
            <ListItem><a href="/cart">Cart</a></ListItem>
            <ListItem><a href="/productListLogged">Fashion</a></ListItem>
        ...
        <Right>
          <Title>Contact</Title>
          <ContactItem>
            <Room style={{marginRight:"10px"}}/> Av. João Jacinto de Magalhães, 3810-193 Aveiro
          </ContactItem>
          <ContactItem>
            <Phone style={{marginRight:"10px"}}/> +351 924355649
          </ContactItem>
          <ContactItem>
            <MailOutline style={{marginRight:"10px"}} /> contact@onwear.com
          </ContactItem>
